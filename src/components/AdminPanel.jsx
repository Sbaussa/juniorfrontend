  ...
  return (
    <div className="ap-view">
      ...
      <div className="ap-section-card">
        ...
        <div className="ap-empty"><Package size={28} color="#1e1e1e" /><span className="ap-empty-txt">Sin actividad registrada</span></div>
      </div>
    </div>
  );
}
...
@media (max-width: 767px) {
  ...
  .ap-mobile  { display: flex; flex-direction: column; min-height: 100dvh; }
}
...
/* Sidebar */
.ap-sidebar {
  width: 220px; min-width: 220px; background: #0d0d0d;
...
.ap-logo-icon {
  width: 30px; height: 30px; border-radius: 8px; background: #39ff14;
...
.ap-user-card {
  display: flex; align-items: center; gap: 10;
  padding: 10px 8px; background: #131313; border-radius: 8px; margin-bottom: 6px;
}
.ap-avatar-sm {
  width: 30px; height: 30px; border-radius: 50%; background: #39ff14; color: #000;
  display: flex; align-items: center; justify-content: center;
  font-size: 12px; font-weight: 900; font-family: 'Orbitron', sans-serif; flex-shrink: 0;
}
...
.ap-main { flex: 1; overflow: hidden; display: flex; flex-direction: column; overflow-y: auto; }

/* ══════════════ MOBILE ══════════════ */
.ap-topbar {
  display: flex; align-items: center; justify-content: space-between;
  padding: 12px 18px; background: #0d0d0d; border-bottom: 1px solid #1e1e1e;
  position: sticky; top: 0; z-index: 50; flex-shrink: 0;
}
.ap-logo-mobile { display: flex; align-items: center; gap: 10; text-decoration: none; }
.ap-logo-icon-sm {
  width: 32px; height: 32px; border-radius: 9px; background: #39ff14;
  display: flex; align-items: center; justify-content: center;
}
.ap-topbar-right { display: flex; gap: 8; align-items: center; }
.ap-icon-pill {
...
.ap-bottom-nav {
  ...
  padding: 10px 6px 22px; z-index: 100;
}
.ap-tab-btn {
...
.ap-big-avatar {
  width: 56px; height: 56px; border-radius: 50%; background: #39ff14; color: #000;
  display: flex; align-items: center; justify-content: center;
...
.ap-danger-row {
  ...
  width: 100%; padding: 16px; background: rgba(255,59,59,0.06);
  border: 1px solid rgba(255,59,59,0.15); border-radius: 14px; cursor: pointer; margin-top: 4px;
}
